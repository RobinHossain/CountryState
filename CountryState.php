<?php
/* 
Name: Simple PHP Script to get all country with states.
Description: I got a file that contains all countries, states and iso code list. 
...
Author Name: Robin Hossain
Author Website: http://w3bd.com
...
class CountryState {
 ...
 ['Zimbabwe', 'ZW', 'ZWE', '716', 'ISO 3166-2:ZW', 'Bulawayo|Harare|ManicalandMashonaland Central|Mashonaland East|Mashonaland West|Masvingo|Matabeleland North|Matabeleland South|Midlands', '263']
	...
	public function countriesStates(){
		$list = array();
		$i = 0;
		foreach($this->sorted_countries as $rarray){
			$list[$i]['c']=$rarray[0];
